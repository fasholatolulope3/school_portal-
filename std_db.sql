...
ALTER TABLE student_quiz_answers ADD FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
ALTER TABLE student_quiz_answers ADD FOREIGN KEY (question_id) REFERENCES quiz_questions(id);
ALTER TABLE quiz_feedback ADD FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
--
