                	...
                	<form role="form" action="../index.php" method="post">
                  		<div class="box-body">
							...
							<div class="form-group" id="divSubject">
                      			...
                      			<select class="form-control" id="level" placeholder="Enter Subject name" name="level">
...
$sql="SELECT * FROM `subject` WHERE `status` = 'Active' ORDER BY `level` DESC"; //MSK-000113-Active status
