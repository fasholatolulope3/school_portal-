...
<div class="content-wrapper">
      ...
      on subject_routing.teacher_id=teacher.id";
								...
								?>
										<tr>
											...
											<!--MSK-000115-td4-->
											<td id="td4_<?php echo $count; ?>"><?php echo $row['s_fee']; ?></td>
							...
							<form role="form" action="../index.php" method="post">
								<div class="panel-body"> <!-- Start of modal body-->
									...
									<div class="form-group" id="divLevel">
										...
										<select class="form-control" id="level_add" name="level_add">
	...
	<script>
		$("#level_add").change(function() {
			console.log("Level changed");
			var level = $(this).val();
			$.get("../model/get_subject_by_level.php", {
				level: level
			}, function(data) {
				console.log(data);
			...
			$.get("../model/get_grade_by_level.php", {
				level: level
			}, function(data) {
				console.log(data);
					...
					<div class="col-md-3 ">
						<div class="panel">
							...
							<div class="panel-body"> <!-- Start of the modal body-->
								<div class="form-group" id="divLevel">
									<label for="">Level</label>
									<select class="form-control" id="level1" name="level_id">
										<option value="">Select Level</option>
										<option value="JSS">Junior Secondary School</option>
										<option value="SSS">Senior Secondary School</option>
									</select>
